...
print_json([
  ...
  'icons' => [
     [
      'src' => 'img/static/logo_'.$site->ID.'_120x120.png',
      'sizes' => '120x120',
      'type' => 'image/png',
    ],
     [
      'src' => 'img/static/logo_'.$site->ID.'_180x180.png',
      'sizes' => '180x180',
      'type' => 'image/png',
    ],
     [
      'src' => 'img/static/logo_'.$site->ID.'_192x192.png',
      'sizes' => '192x192',
      'type' => 'image/png',
    ],
     [
      'src' => 'img/static/logo_'.$site->ID.'_512x512.png',
      'sizes' => '512x512',
      'type' => 'image/png',
    ],
  ],
