  ...
  foreach($sites as $each_site) {
    echo "
      <tr class='".($each_site['id'] == $active_edit_site ? 'active' : '')."'>
        ...
        <td data-enabled='".($each_site['enabled'] == 1 ? 1 : 0)."'>".($each_site['enabled'] == 1 ? '<img alt="check" src="/img/static/circle-check.svg" class="icon">' : '<img alt="x" src="/img/static/circle-x.svg" class="icon">')."</td>
