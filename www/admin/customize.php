...
if (
  $_POST['site_name'] || $_POST['short_name'] || $_POST['email_from_address'] || $_POST['email_from_name'] ||
...
foreach ($db->select("SELECT * FROM images WHERE site_id = " . $site->ID) as $image) {
  ...
  echo "<tr>
    ...
    <td><img alt='image preview' src='/admin/image?f=$image[uploads_dir_filename]' class='thumbnail'></td>
    <td>
      <form method='post'>
